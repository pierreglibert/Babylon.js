...
>>>>>>> de541d29fa133a638e4d2a6eefbfa8e46eb1eeb1
declare module BABYLON {
    class Collider {
        radius: Vector3;
        retry: number;
...
>>>>>>> c460fd1d04dded7130be6d70de2e719986f05d42
        /**
         * Updates the Color3 rgb values from the passed floats.
         * Returns the Color3.
         */
...
declare module BABYLON {
     ...
     * ***********************************
     */
    class renderGradingSceneOptimizer {
        frameToReach: number;
        trackerDuration: number;
        private starterGrade;
        private autoRunDelay;
        grades: Array<any>;
        private _currentGrade;
        private _currentGradingStep;
        private _hardwareEval;
        /**
         ...
         */
        constructor(scene: Scene, frameToReach: number, trackerDuration: number, starterGrade: string, autoRunDelay?: number);
        addGrade(newGrade: grade): void;
        run(scene: Scene): void;
        updateSceneByGrade(gradeName: string): void;
        downgrade(): void;
        upgrade(): void;
        getHardwareEvaluation(scene: Scene): void;
    }
    class grade {
        name: string;
        upGradingTask: Function;
        downGradingTask: Function;
        activeDynamicGradingAssetsLoad: boolean;
        gradingAssets: Array<gradingAsset>;
        private _priority;
        /**
         ...
         */
        constructor(name: string, upGradingTask: Function, downGradingTask: Function, activeDynamicGradingAssetsLoad?: boolean);
        addGradingAsset(gradingAsset: gradingAsset): void;
        splitAsset(): void;
    ...
    class gradingAsset {
        name: string;
        url: string;
        type: 'scene' | 'mesh' | 'texture' | 'animation';
        AssetGeolocalisation: assetGeolocalisation;
        constructor(name: string, url: string, type: 'scene' | 'mesh' | 'texture' | 'animation', AssetGeolocalisation?: assetGeolocalisation);
    }
    class meshGradingAsset extends gradingAsset {
        name: string;
        url: string;
        meshAssetGeolocalisation: meshAssetGeolocalisation;
        constructor(name: string, url: string, meshAssetGeolocalisation?: meshAssetGeolocalisation);
    }
    class assetGeolocalisation {
        position: Vector3;
        boundingBox: BoundingBox;
        constructor(position: Vector3, boundingBox?: BoundingBox);
    }
    class meshAssetGeolocalisation extends assetGeolocalisation {
        position: Vector3;
        boundingBox: BoundingBox;
        rotation: Vector3;
        scale: Vector3;
        constructor(position: Vector3, boundingBox?: BoundingBox, rotation?: Vector3, scale?: Vector3);
    }
}
